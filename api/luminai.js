...
router.get('/', async (req, res) => {
    ...
    try {
        ...
        const response = await axios.get(`https://restapi.yanzoffc.xyz/api/ai/luminai?text=${encodeURIComponent(userInput)}`);
        ...
        const result = {
            ...
            data: {
                result: response.data.data.result // Ambil hasil dari API eksternal
            }
        };
